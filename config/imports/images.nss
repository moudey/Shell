var
{
	...
	svg_jjjj='<path stroke="@image.color2" stroke-linejoin="round" d="M8 10.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/>'
...
make_available_offline='<svg fill="none" viewBox="0 0 16 16">
  ...
  <path fill="@image.color2" d="M16 11.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"/>
  <path fill="#fff" d="M9.10 11.10c.22-.22.57-.22.79 0l1.60 1.60 1.60-1.60a.56.56 0 11.79.79l-2 2a.56.56 0 01-.79 0l-2-2a.56.56 0 010-.79z"/>
  <path fill="#fff" d="M11.5 9a.5.5 0 01.5.5v4a.5.5 0 01-1 0v-4a.5.5 0 01.5-.5z"/>
</svg>'
